...
public partial class User
{
    ...
    public ICollection<UserInquiry> UserInquiryAssignedTos { get; set; } 

    public ICollection<UserInquiry> UserInquiryCreatedBies { get; set; } 

    public ICollection<UserInquiryMessage> UserInquiryMessages { get; set; }
